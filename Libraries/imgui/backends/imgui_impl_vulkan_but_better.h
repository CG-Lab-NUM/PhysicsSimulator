...
void ImGui_SetupRenderState(ImDrawData* DrawData, VkCommandBuffer CommandBuffer, int FramebufferWidth, int FramebufferHeight)
{
    ...
    float Transform[4];
    Transform[0] = (float)2.0 / DrawData->DisplaySize.x;
    Transform[1] = (float)2.0 / DrawData->DisplaySize.y;
    Transform[2] = (float)-1.0 - DrawData->DisplayPos.x * Transform[0];
    Transform[3] = (float)-1.0 - DrawData->DisplayPos.y * Transform[1];
